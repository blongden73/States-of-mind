...
The research findings and insights gained from implementing the new framework will be presented at a public event in July, hosted by the IOE. We welcome schools, psychologists and anybody interested in educational reform to attend. To express your interest, [join our mailing list here](http://eepurl.com/hiMQMb) for termly updates and news on the project . Stay tuned for announcements about the event and how to register.
