...
- Template: four
  ...
  Description: "Anxiety is a natural fear response that is triggered when you are
    ...
    fear response triggers changes in your feelings, thoughts and behaviour. "
  Graphic Image: 
  Audio url: 
  Video Url: 
  Credit: 
...
- Template: sixteen
  ...
  Description: "Anxiety becomes a problem if you begin to notice a reduced ability
    to cope in your everyday life.\n\nIf you have experienced a situation in the past
    that you have not processed, it can cause you to feel like you can’t manage or
    cope in the present. \n\nThis is because your threat detector, or ‘smoke alarm’
    becomes overactive and responds more sensitively to things you may not normally
...
- Template: sixteen
  ...
  Description: "\nWhen you imagine an aspect of a present or future situation that
    you feel you can’t cope with, your mind tries to solve the problem by thinking
    about it. This can cause a ‘Thought Loop’ that is caused by your thoughts triggering
    more feelings of stress and anxiety, that in turn fuel more thoughts and stronger
    emotions. \n\nThis process of overthinking in relation to a real or imagined future
    scenario that you perceive as threatening, is called ‘ Rumination’. \n\nThe word
    comes from the word ‘ruminate’ which is the continued chewing motion that animals
    use to digest their food. You can think of rumination as the process of ‘chewing
    on your thoughts’. \n\nResearch has shown that people who ruminate more are more
    likely to struggle with anxiety and depression. \n\n "
  Graphic Image: 
  Audio url: 
  Video Url: 
  Credit: 
...
- Template: sixteen
  ...
  Description: "Neuroscientists have identified a distinct neural network in your
    ...
    \n\nWhen the ‘Default Mode’ Network is active, it may look like nothing is happening
...
- Template: sixteen
  ...
  Image: 
  Description: |-
    When you are fearful and anxious, you begin to think differently, bringing awareness to these thought patterns can help you to recognise when you are caught in anxiety.
...
- Template: sixteen
  ...
  Description: |-
    ...
    The hypervigilance caused by anxiety prevents your body from being in a state of relaxation which interrupts the functioning of your circadian rhythms.

    # Loss of memory

    As with concentration, your memory systems are temporarily impaired by anxiety due to the activity of cortisol that is released in the brain during the anxiety response.
  Graphic Image: 
  Audio url: 
  Video Url: 
  Credit: 
...
- Template: sixteen
  ...
  Description: |-
    ...
    Anxiety causes you to avoid situations that may threaten your sense of safety. You may often feel anxiety around social situations if you do not feel  comfortable enough to interact with others, leading to a loop of avoidance and social isolation.
...
- Template: sixteen
  ...
  Description: |-
    ...
    Paul Gilbert described 3 main aspects of your emotional regulation system. You will always be experiencing at least one of these states and your wellbeing depends on us experiencing a healthy balance between all 3.
...
- Template: sixteen
  ...
  Description: "One of the traps that you can get caught in when you are stressed
    and anxious is mistaking the Drive system for the Soothing System.\n\nWhen this
    happens, you mistake the feelings of relief you get from distracting yourself,
    with the restoring and reassuring states that you access through your soothing
    system. \n\nAn example of this is getting home from a long day and feelings stressed
    and tired. You chose to go on Instagram all night to distract yourself from the
    stress of the day. Instead of paying attention to your feelings and caring for
    yourself, you get caught in the ‘seeking mode' of looking for something to distract
    you from your uncomfortable feelings. \n \n\n"
  Graphic Image: 
  Audio url: 
  Video Url: 
  Credit: 
...
- Template: five
  ...
  Description: |-
    ...
    It requires you to listen carefully to the messages your fears hold and listen with kindness to what they are telling you about the ideas that you have about yourself, so that you can uncover the underlying belief, explore it and let it go.
  Graphic Image: 
  Audio url: 
  Video Url: 
  Credit: 
...
- Template: four
  ...
  Description: "To break out of the stress response, you need to re-engage your body
    to remind your body that it is safe. \n\nWhen your body feels it is safe, it is
    able to process new information that can help you to see new possibilities.\n\nThis
    part of the module explores how you can activate the soothing system through exercise,
...
- Template: sixteen
  ...
  Description: |-
    ...
    Exercise is beneficial for anxiety as it reduces your levels of cortisol and increases your endorphins which improve your mood.
...
- Template: sixteen
  ...
  Description: |-
    ...
    When you practice slow and deep breathing, it activates the vagus nerve which sends a signal to your brain that tells your body it can relax.

    \
    Breathing exercises help to quiet the mind and return your awareness to the present moment.
  Graphic Image: 
  Audio url: 
  Video Url: 
  Credit: 
...
- Template: five
  ...
  Description: |-
    ...
    As the anxiety is often accompanied by persistent worrying about the past and future, by bringing your awareness to the present moment, you can redirect your attention and focus to the here and now and relieve yourself of distressing thought patterns.
  Graphic Image: 
  Audio url: 
  Video Url: 
  Credit: 
...
- Template: sixteen
  ...
  Image: 
  Description: |-
    The Default mode is switched OFF when you focus your attention on tasks or ‘doing things’. When you are in this mode, your ‘ Task Positive Network’ is activated. You can see this network as the ‘solution focused network.’ These networks are similar to a switch, when one is ON the other is OFF. 
...
- Template: sixteen
  ...
  Description: "The anxiety response is kept going when you avoid your feelings through
    ...
    to your discomfort and distress and understanding that your pain and suffering
    is a normal part of being human. \n\nBy bringing an attitude of care and acceptance
    towards yourself, you can focus your energy away from your worries and concerns,
    towards a dedicated attempt to reassure and support yourself. \n\nBy turning towards
    your feelings, instead of resisting them, you can begin to self soothe and calm
    your anxiety.    "
  Graphic Image: 
  Audio url: 
  Video Url: 
